...
class _UserDetailsScreenState extends State<UserDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          _buildUserDetail("Mobile Number", mobileNumberController),
          _buildUserDetail("Email", emailController),
          _buildUserDetail("Role", roleController),
          _buildUserDetail("Status", statusController),
            ...
            child: Container(
                ...
                child: ListView(
                  children: [
                    ...
                    _buildUserDetail("Name", nameController),
                    _buildUserDetail("First Name", firstnameController),
                    _buildUserDetail("Last Name", lastnameController),
                    Padding(
