              ...
              children: [
                Container(
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        const Text("Device", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                        Padding(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(device["name"] ?? "", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                          ),
                          Padding(
                            padding: EdgeInsets.only(top: 5, left: 20),
                            child: Text(device["deviceId"] ?? "", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                          ),
                          Padding(
